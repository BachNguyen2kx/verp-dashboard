...
graph LR
    ...
    subgraph MACHINE ["⚙️ THIẾT BỊ (MACHINE)"]
    ...
    Backbone --> Problem["⚠️ VẤN ĐỀ CHÍNH:<br>1. Biên LN ròng chỉ đạt 18.94%<br>    (LN ròng: 1,877,126 / DT: 9,909,640)<br>2. Trễ tiến độ đóng cont thành phẩm"]
